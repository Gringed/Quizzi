                            ...
                            <div className="left">
                                <div className="img-uploader">
                                    ...
                                    <div className="upload-box">
                                        ...
                                        <input onChange={(e) => this.handleFileInputChange(e)} type="file" name='file' id='file'/>
                                    ...
                                    <div style={{color: this.state.message === 'Succès' ? 'green' : 'red', fontSize: '.8em', margin: '20px 0'}}>{ this.state.message }</div>
                                    <button className="image-btn" style={{marginTop: '20px'}} onClick={(e) => this.handleSubmitFile(e)}>Sauvegarder</button>
                                </div>
                            </div>
                        </div>
                    }
