    ...
    render() {
        return (
            <div className="community-quizzes-wrapper">
                ...
                <div className="body">
                    <div className="header-top">Tout les quiz crées</div>
                    <div className="quizzes-wrapper">
                        {this.state.quizzes.map((quiz, idx) => (
                            <div key={idx} className="quiz-card card">
                                ...
                                <div className="take-quiz btn" onClick={() => this.takeQuiz(quiz._id)}>Répondre à ce quiz</div>

                                <div className="top-section">
                                    <div className="likes">{quiz.likes} <img onClick={() => this.likeQuiz(quiz._id)} src="https://cdn0.iconfinder.com/data/icons/small-n-flat/24/678087-heart-512.png" /></div>
                                </div>
                            </div>
                        ))}
                    </div>
